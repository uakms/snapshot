...
; SBCL 向け
;
; Usage: sbcl --script  mto-sbcl.lisp options inputfile
...
(defparameter *mtorootdir*
  (cl-ppcre:regex-replace "mto-sbcl.lisp" (namestring *scriptname*) ""))
...
; 使い方説明
(defun mto-usage ()
  (format t "Usage: clisp mto-sbcl.lisp options inputfile
options:
